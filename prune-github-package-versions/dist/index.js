...
async function run() {
  try {
    const owner = core.getInput("owner") || import_github.context.repo.owner;
    ...
    const minVersionsToKeep = Number.parseInt(core.getInput("min-versions-to-keep"), 10);
    ...
    const versions = await asyncIteratorToArray(getVersions({ owner, packageName, packageType, octokit }));
...
var PACKAGE_TYPES = /* @__PURE__ */ new Set([
  "npm",
  "maven",
  "rubygems",
  "docker",
